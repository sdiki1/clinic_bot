...
class LoyaltyReminderConfig(Base):
    ...
    message_24h: Mapped[str] = mapped_column(
        ...
        nullable=False,
        default=(
            "Вы еще не активировали систему лояльности.\n"
            "Нажмите кнопку «Система лояльности», чтобы перейти в систему."
        ),
    )
    message_5d: Mapped[str] = mapped_column(
        ...
        nullable=False,
        default=(
            "Напоминаем: система лояльности все еще не активирована.\n"
    ...
    message_7d: Mapped[str] = mapped_column(
        ...
        nullable=False,
        default=(
            "Система лояльности все еще ждет активации.\n"
            "Нажмите «Система лояльности» и завершите переход."
        ),
    )
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False, default=utcnow)
    updated_at: Mapped[datetime] = mapped_column(
