...
- Веб-админка: дашборд, лиды, пользователи, создание/редактирование deep-link ссылок (PDF + сообщение + синяя кнопка), до 7 стартовых документов, напоминания loyalty и все системные тексты бота
...
Раздел с текстами бота:
`http://localhost:8080/bot-texts`.
